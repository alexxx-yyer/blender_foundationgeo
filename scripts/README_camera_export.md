...
### 1. `export_cam_and_render.py`
单个 .blend 文件的相机参数导出脚本。

### 2. `batch_export_cameras.py`
批量处理目录中所有 .blend 文件的脚本。
...
```bash
# 基本用法（输出到 .blend 文件同目录）
blender --background --python export_cam_and_render.py -- /home/alex/projects/FoundationGeo/data/blender/blender-4.1-splash.blend

# 指定输出目录
blender --background --python export_cam_and_render.py -- \
...
python3 batch_export_cameras.py /home/alex/projects/FoundationGeo/data/blender
